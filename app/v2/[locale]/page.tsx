...
import { LOCALE_CODES, isLocale, getDirection, type Locale } from '../_configs/locales'
...
export async function generateMetadata({
  ...
  return {
    title: 'Klinchapp V2 — Homepage (staging)',
    description:
    ...
    <div dir={dir} className="min-h-screen bg-gradient-to-br from-[#FDFAFF] via-[#FDF2F8] to-[#FFF8F8] text-gray-900">
      ...
      <section id="how" className="max-w-6xl mx-auto px-6 py-16">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="text-4xl md:text-5xl font-extrabold leading-tight mb-6">
            From product photo to platform-ready posts<br />
            <span className="text-[#6B2C6B]">in four steps.</span>
          </h2>
      ...
      <section id="audiences" className="max-w-7xl mx-auto px-6 py-20">
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          <h2 className="text-4xl md:text-5xl font-extrabold leading-tight mb-6">
            Built for people who post<br />
            <span className="text-[#6B2C6B]">across platforms, in multiple languages.</span>
          </h2>
        </div>
      ...
      <section className="max-w-5xl mx-auto px-6 py-20">
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          <h2 className="text-4xl md:text-5xl font-extrabold leading-tight mb-6">
            Not another text-only<br />
            <span className="text-[#6B2C6B]">caption generator.</span>
          </h2>
          <div className="text-lg text-gray-600 space-y-1">
            <p>Most AI tools start with a text prompt and one platform.</p>
            <p>Klinchapp starts with what you sell.</p>
          </div>
        </div>
      ...
      <section id="tones" className="max-w-7xl mx-auto px-6 py-20">
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          <h2 className="text-4xl md:text-5xl font-extrabold leading-tight mb-6">
            Same image. Same platform.<br />
            <span className="text-[#6B2C6B]">Nine visibly different voices.</span>
          </h2>
          <div className="text-lg text-gray-600 space-y-1 mb-3">
            <p>One white slip-on sneaker — written nine ways for Instagram.</p>
            <p>The voice you choose is the voice you ship.</p>
          </div>
          <span className="v2-ai-sample-badge">AI sample output</span>
        </div>
      ...
      <section className="max-w-7xl mx-auto px-6 py-20">
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          <h2 className="text-4xl md:text-5xl font-extrabold leading-tight mb-6">
            AI-generated, in six languages.<br />
            <span className="text-[#6B2C6B]">Including right-to-left Arabic.</span>
          </h2>
          <div className="text-lg text-gray-600 space-y-1 mb-3">
            <p>Same image, six languages.</p>
            <p>Klinchapp writes directly in your audience&apos;s language — hashtags localize too.</p>
          </div>
          <span className="v2-ai-sample-badge">AI sample output</span>
        </div>
