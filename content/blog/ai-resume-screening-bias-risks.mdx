...
description: "AI resume screening saves hours but bakes old bias into every hire. Learn the real tradeoffs before automation costs you great candidates."
...
author: Kira
hook: >-
  AI resume screening saves 52 hours a week. Lawyers charge more than that to
  clean up the bias lawsuits.
social:
  twitter: >-
    Your hiring AI just screened out a perfect candidate—and you'll never know
    it happened. Amazon learned this the hard way in 2018. What bias risks is
    your resume screening tool hiding? #AIHiring #HRTech
  linkedin: >-
    Your AI resume screener just rejected a qualified candidate in 0.3 seconds.


    You don't know it happened. Amazon didn't either—until 2018, when they
    scrapped their AI hiring tool after discovering it systematically
    discriminated against women.


    The truth about AI resume screening is messy: the productivity gains are
    real (recruiters report 60-70% time savings on initial screening), but the
    bias risks are equally real and often invisible.


    Here's what's changed since Amazon's misstep:


    • NYC's AEDT bias audit law (effective 2023) now requires transparency
    before deployment

    • The EEOC published explicit 2023 guidance flagging AI employment tools as
    discrimination liability

    • The EU AI Act classifies HR AI as high-risk—same category as facial
    recognition


    But here's the practical part: most companies deploying these tools don't
    have an audit process in place. They're chasing speed without
    accountability.


    Before you deploy—or if you already have—you need to know: What's your audit
    roadmap? And are you actually disclosing the tool's limitations to
    candidates?
  ...
  tiktok: "Hot take: Your AI just rejected someone & you'll never know if it was wrong \U0001F6A8 Amazon learned that lesson in 2018. Here's what hiring teams need to know about bias in recruitment AI—and how to actually fix it."
qualityScore: 8
status: published
---
...
AI resume screening cuts your workload by 75%, but it quietly perpetuates hiring bias baked into your past hiring data. The speed is real. The problem is real too. You're trading time for blind spots—systematically filtering out candidates without understanding why.
